...
contains(CREDIT_NEED_QT_PLUGINS, 1) {
    DEFINES += CREDIT_NEED_QT_PLUGINS
...
# also add new translations to src/qt/credit.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/credit_*.ts)
...
HEADERS += \
    ...
    src/qt/creditunits.h \
    src/qt/creditgui.h \
    src/qt/creditamountfield.h \
...
SOURCES += \
    ...
    src/qt/credit.cpp \
    src/qt/creditaddressvalidator.cpp \
    src/qt/creditamountfield.cpp \
    src/qt/creditgui.cpp \
    src/qt/creditstrings.cpp \
    src/qt/creditunits.cpp \
    ...
    src/script/creditconsensus.cpp \

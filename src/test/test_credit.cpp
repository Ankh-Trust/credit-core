...
#define BOOST_TEST_MODULE Credit Test Suite

#include "test_credit.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_credit_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

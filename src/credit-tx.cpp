...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help")) {
        ...
        std::string strUsage = strprintf(_("%s credit-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  credit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded credit transaction") + "\n" +
                               "  credit-tx [options] -create [commands]   " + _("Create hex-encoded credit transaction") + "\n" +
                               "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CCreditAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CCreditAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded credit transaction

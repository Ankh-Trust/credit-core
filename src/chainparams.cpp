...
public:
    CMainParams()
    {
        ...
        consensus.nMinCountServiceNodesPaymentStart = 20;  // ServiceNode Payments begin once 5 ServiceNodes exist or more.
      ...
      (409354, uint256S("0x00000887eaa4980509717611578fc837db08352d33d6a5aad658777bd804fb2a"))
	};

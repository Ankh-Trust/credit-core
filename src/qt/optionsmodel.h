...
#ifndef CREDIT_QT_OPTIONSMODEL_H
#define CREDIT_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Credit client.
...
#endif // CREDIT_QT_OPTIONSMODEL_H

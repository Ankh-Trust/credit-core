...
#ifndef CREDIT_QT_CREDITGUI_H
#define CREDIT_QT_CREDITGUI_H
...
// Credit : to ensure that we can click on lock icon in GUI
...
/**
  Credit GUI main class. This class represents the main window of the Credit UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CreditGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CreditGUI(const PlatformStyle* platformStyle, const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~CreditGUI();

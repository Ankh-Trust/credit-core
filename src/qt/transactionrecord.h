...
#ifndef CREDIT_QT_TRANSACTIONRECORD_H
#define CREDIT_QT_TRANSACTIONRECORD_H
...
public:
    ...
    enum Status {
        Confirmed, /**< Have 50 or more confirmations (normal tx) or fully mature (mined tx) **/
...
#endif // CREDIT_QT_TRANSACTIONRECORD_H

...
#ifndef CREDIT_QT_CREDITUNITS_H
#define CREDIT_QT_CREDITUNITS_H
...
/** Credit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CreditUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CreditUnits(QObject* parent);
...
typedef CreditUnits::Unit CreditUnit;

#endif // CREDIT_QT_CREDITUNITS_H

...
CDHTSettings::CDHTSettings(const uint16_t ordinal, const uint16_t threads, const bool multithreaded)
{
    ...
    user_agent = "Credit v" + FormatFullVersion();
...
void CDHTSettings::LoadSettings()
{
    ...
    // used instead
    //settings.set_str(settings_pack:handshake_client_version, "Credit"); //todo: add version to user agent

...
====================================
This guide will show you how to build creditd (headless client) for OSX.
...
------------------------
You can ignore this section if you are building `creditd` for your own use.

creditd/credit-cli binaries are not included in the Credit-Qt.app bundle.

If you are building `creditd` or `Credit-Qt` for others, your build machine should be set up
...
Once dependencies are compiled, see release-process.md for how the Credit-Qt.app
bundle is packaged and signed to create the .dmg disk image that is distributed.

Running
-------

It's now available at `./creditd`, provided that you are still in the `src`
directory. We have to first create the RPC configuration file, though.

Run `./creditd` to get the filename where it should be put, or just try these
commands:
...
-------
    ...
    ./creditd -daemon # to start the credit daemon.
    ./credit-cli --help  # for a list of command-line options.
    ./credit-cli help    # When the daemon is running, to get a list of RPC commands

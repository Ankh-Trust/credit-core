...
[![Throughput Graph](https://graphs.waffle.io/.../Credit/throughput.svg)](https://waffle.io/.../Credit/metrics/throughput)  

# **Credit (0AC) v1.0.0.0**

![0AC logo](https://github.com/hmlsanders/credit-core/blob/master/src/qt/res/icons/about.png)
...
[Credit(0AC)] allows fast, secure, verifiable transfers of data using blockchain technology and enables third-party developers to build low-cost solutions across varied industry using the BDAP protocol. Credit can be used to run incentivized ServiceNodes; the second tier of nodes on the network processing, verifying, validating and storing data.
...
UNIX BUILD NOTES
====================
Some notes on how to build [Credit](https://duality.solutions/credit) in Unix.
